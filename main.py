...
Owner: Aryan Vishwakarma
Purpose:
- Interactive entry point for end-to-end Project Solva execution.
Responsibilities:
...
def _print_header() -> None:
    print("=" * 64)
    print("Project Solva - Interactive Pipeline Runner")
    print("=" * 64)
...
def main() -> None:
    """Run Project Solva pipeline phases in strict sequence with an interactive prompt."""
    _print_header()
